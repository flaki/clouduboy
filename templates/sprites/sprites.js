...
let sprite1, sprite2, sprite;

game.setup(function(mctx) {
  sprite1 = mctx.loadGraphics(
...
function loop() {
  ...
  // TODO: game.eraseImage(cSprite ? sprite1 : sprite2, 0 +x,2 +y);
  // game.eraseImage(cSprite ? sprite1 : sprite2, 2 +x,2 +y);

  // Draw Bat
  game.drawImage(bat[cSprite|0], 1 +x,1 +y);
